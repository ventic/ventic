...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      // Optional: a build without them simply has no Trakt to connect to, and
      // Settings → Account says so. Register one at trakt.tv/oauth/applications
      // with "urn:ietf:wg:oauth:2.0:oob" as the redirect URI.
      TRAKT_ID: process.env.TRAKT_ID,
      TRAKT_SECRET: process.env.TRAKT_SECRET,
    },
  },
  css: [
