 ...
 * stick and mailed to yourself; an OAuth token in one is a credential you can't
 * take back once the file has been anywhere. Signing in again is six digits.
 */
const SECRET = new Set([`${PREFIX}trakt`])
