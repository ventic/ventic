...
// This page's art is the app backdrop.
watch(media, value => value && ui.select(value), { immediate: true })
        ...
        <div class="flex flex-col gap-6 sm:flex-row sm:items-end">
          ...
          <div v-if="media" class="flex min-w-0 flex-1 flex-col gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2 pt-2">
              ...
              <!-- Only once it has been watched: Trakt refuses a favourite for
                   anything else, and the watchlist is the button for "later". -->
              <v-btn v-if="library.canFavourite(media)" icon variant="text" color="on-surface" :size="mobile ? 'default' : 'large'" @click="library.toggleFavourite(media)">
